export const translations = {
  en: {
    ...
    offers2: {
      ...
      uiux: 'UI/UX Design',
      uiuxDesc: 'Modern interface design with attention to user experience:',
      uiuxTools: ['Responsive Design', 'Tailwind CSS', 'Smooth Animations', 'Dark Mode', 'Accessibility Focus'],
