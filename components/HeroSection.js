          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white dark:bg-slate-800 border-2 border-primary-600 dark:border-primary-400 text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-slate-700 font-semibold rounded-lg transition-colors shadow-md hover:shadow-lg"
              >
