...
export default function QuickStatsSection() {
  ...
  return (
    <section ref={statsRef} className={`py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary-600 via-primary-700 to-blue-700 dark:from-primary-900 dark:via-primary-800 dark:to-blue-900 ${statsInView ? 'animate-fade-in' : 'opacity-0'}`}>
